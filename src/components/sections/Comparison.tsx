                        ...
                        <thead>
                            <tr>
                                ...
                                <th className="w-[26%] p-6 text-left align-bottom pb-8">
                                    <span className="text-[17px] font-bold text-[#F5F5F5]">{dict.comparison.fulltime}</span>
                                </th>
                                <th className="w-[26%] p-6 text-left align-bottom pb-8">
                                    <span className="text-[17px] font-bold text-[#F5F5F5]">{dict.comparison.agencies}</span>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <tr key={idx} className="border-b border-[#1F1F1F] last:border-0 hover:bg-[#111] transition-colors duration-300">
                                    ...
                                    <td className="p-6">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <span className="text-[#F5F5F5] text-[15px] font-medium leading-relaxed">{row.frack}</span>
                                        </div>
                                    </td>
                                    <td className="p-6">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <span className="text-[#F5F5F5] text-[15px] font-medium leading-relaxed">{row.fulltime}</span>
                                        </div>
                                    </td>
                                    <td className="p-6">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <span className="text-[#F5F5F5] text-[15px] font-medium leading-relaxed">{row.agencies}</span>
                                        </div>
                                    </td>
                                </tr>
                            ))}
